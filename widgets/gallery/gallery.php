...
class ElementsKit_Widget_Gallery extends Widget_Base
{
	...
	public function get_style_depends(): array {
		return [ 'gallery-filter', 'ekit-pro-gallery' ];
	}

	public function get_script_depends() {
		return ['tilt', 'imagesloaded', 'gallery-filter', 'ekit-pro-gallery'];
    }
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'selectors' => [
                    ...
                    '{{WRAPPER}} .elementskit-single-portfolio-item .elementskit-gallery-icon svg' => 'fill: {{VALUE}}',
                ],
            ]
        );
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'selectors' => [
                    ...
                    '{{WRAPPER}} .elementskit-single-portfolio-item:hover .elementskit-gallery-icon svg'  => 'fill: {{VALUE}};'
                ],
            ]
        );
...
?>
        ...
        ?>
                        <div data-category="<?php echo esc_attr($item['ekit_gallery_filter_label']); ?>" class="filter-item ekit_gallery_grid_item <?php echo esc_attr($this->clean_class($item['ekit_gallery_filter_label']) . ' ' . $gallery_grid_class); ?>">
