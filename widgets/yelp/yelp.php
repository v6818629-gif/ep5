...
class ElementsKit_Widget_Yelp extends Widget_Base
{
	...
	public function get_style_depends() {
		return ['ekit-social-reviews-common', 'ekit-layout-responsive', 'ekit-pro-yelp'];
	}
            ...
            <div class="ekit-review-wrapper ekit-review-wrapper-yelp">
				...
				<?php if($ekit_review_styles == 'default') :
					...
					if(!empty($data->reviews)):
						...
						?>
						<div class="ekit-review-cards <?php echo esc_attr( "ekit-review-cards-" . $ekit_review_card_appearance ) ?>">
							<?php
