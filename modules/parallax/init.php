...
class Init{
    ...
    public function __construct(){
		...
		// get current module's libs url
		$this->libs_url = \ElementsKit::plugin_url() . 'assets/libs/';
	...
	private function get_assets_config() {
		return [
			...
			'scripts' => [
				'jarallax' => [
					'src' => $this->libs_url . 'jarallax/jarallax.js',
					'version' => \ElementsKit::version(),
					'dependencies' => [],
					'in_footer' => true,
				],
				'animejs' => [
					'src' => $this->libs_url . 'animejs/anime.js',
					'version' => \ElementsKit::version(),
					'dependencies' => [],
					'in_footer' => true,
				],
				'ekit-tweenmax' => [
					'src' => $this->libs_url . 'tweenmax/TweenMax.min.js',
					'version' => \ElementsKit::version(),
					'dependencies' => ['animejs'],
					'in_footer' => true,
				],
				'ekit-jquery-easing' => [
					'src' => $this->libs_url . 'jquery-easing/jquery.easing.1.3.js',
					'version' => \ElementsKit::version(),
					'dependencies' => ['jquery', 'animejs'],
					'in_footer' => true,
				],
				'ekit-tilt' => [
					'src' => $this->libs_url . 'tilt/js/tilt.jquery.min.js',
					'version' => \ElementsKit::version(),
					'dependencies' => ['jquery', 'animejs'],
					'in_footer' => true,
				],
				'ekit-magician' => [
					'src' => $this->libs_url . 'magician/magician.js',
					'version' => \ElementsKit::version(),
					'dependencies' => ['animejs'],
					'in_footer' => true,
				],
