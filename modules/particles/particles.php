...
class ElementsKit_Particles {
    ...
    public function get_register_scripts() {
        return [
            'scripts' => [
                [
                    'name' => 'ekit-particles',
    ...
    public function register_particles_controls($element) {
        $element->start_controls_section(
            ...
            [
                ...
                'label' => ( method_exists( Utils::class, 'get_promo_icon' ) ? Utils::get_promo_icon() : 'ElementsKit' ) . esc_html__( 'Particles', 'elementskit' ),
            ]
        );
        ...
        $element->add_control(
            ...
            [
                ...
                'return_value' => 'yes',
                'assets' => $this->get_register_scripts(),
            ]
        );
