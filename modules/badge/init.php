<?php
namespace ElementsKit\Modules\Badge;
...
class Init {
	...
	public function __construct() {
		...
		$this->url = \ElementsKit::plugin_url() . 'modules/badge/';

		// include all necessary files
		$this->include_files();

		// calling the wrapper controls
		new \Elementor\ElementsKit_Badge();
	...
	private function get_assets_config() {
		return [
			'styles' => [
				'ekit-badge' => [
					'src' => $this->url . 'assets/css/ekit-badge.css',
			...
			'scripts' => [
				'lottie' => [
					'src' => \ElementsKit_Lite::plugin_url() . 'assets/libs/lottie/lottie.min.js',
					'version' => \ElementsKit_Lite::version(),
					'dependencies' => [],
					'in_footer' => true,
				],
				'ekit-badge' => [
					'src' => $this->url . 'assets/js/ekit-badge.js',
					'version' => \ElementsKit::version(),
